...
##TODO this is copied from utils.py, find a better way
def nonzero(tensor):
    """
...
class BoxList(object):
    ...
    # Tensor-like methods
    # **kwargs enables forwarding of e.g. non_blocking=True.
    ...
    def __getitem__(self, item):
        # index_select is more efficient on GPU than advanced indexing, so use that
        item_type=item.type()
