...
class Maskrcnn:
    ...
    def run_on_opencv_image(self, image, confidence_threshold=0.7):
        """
        Arguments:
            image (np.ndarray): an image as returned by OpenCV
        ...
        top_predictions = self.predict(image, confidence_threshold)
    ...
    def select_top_predictions(self, predictions, confidence_threshold):
        """
