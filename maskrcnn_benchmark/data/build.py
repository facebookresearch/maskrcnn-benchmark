...
from .datasets.data import InstanceSegDataset
...
def build_dataset(hparams, transforms, is_train=True):
    """
    Arguments:
...
#             args["use_difficult"] = not is_train
    args={}
#     args['remove_images_without_annotations']=is_train
#     args['use_diffcult']=not is_train
    args["transforms"] = transforms
    args['hparams']=hparams
    args['is_train']=is_train
        # make dataset from factory
#         dataset = factory(**args)
    dataset=InstanceSegDataset(**args)
...
#     dataset_list = cfg.DATASETS.TRAIN if is_train else cfg.DATASETS.TEST
    ...
    hparams={}
    datasets = build_dataset(hparams,transforms, is_train or is_for_period)
