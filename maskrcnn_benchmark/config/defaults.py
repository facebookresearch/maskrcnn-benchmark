...
# KITTI 3D det
_C.MODEL.ROI_GEO_ATTR_HEAD = CN()
_C.MODEL.ROI_GEO_ATTR_HEAD.FEATURE_EXTRACTOR = "GEOATTRRCNNFeatureExtractor"
_C.MODEL.ROI_GEO_ATTR_HEAD.PREDICTOR = "GEOATTRRCNNPredictor"
_C.MODEL.ROI_GEO_ATTR_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_GEO_ATTR_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_GEO_ATTR_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_GEO_ATTR_HEAD.MLP_HEAD_DIM = 1024
_C.MODEL.ROI_GEO_ATTR_HEAD.CONV_LAYERS = tuple(512 for _ in range(8))
_C.MODEL.ROI_GEO_ATTR_HEAD.RESOLUTION = 14
# _C.MODEL.ROI_GEO_ATTR_HEAD.NUM_CLASSES = 17
_C.MODEL.ROI_GEO_ATTR_HEAD.CLASS_NAME_MAP = ()
_C.MODEL.ROI_GEO_ATTR_HEAD.AVG_DIMS = ()
_C.MODEL.ROI_GEO_ATTR_HEAD.ORI_BIN = 2
_C.MODEL.ROI_GEO_ATTR_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
