...
**step 3**. Two classes are needed. The first class fetch one image and its corresponding bbox, label with bundling the bbox and label using the BoxList step. This class is a counterpart of the parent class of the [COCODataset](https://github.com/facebookresearch/maskrcnn-benchmark/blob/f25c6cff92d32d92abe8965d68401004e90c8bee/maskrcnn_benchmark/data/datasets/coco.py#L9).  The first class generates a tuple (img, bbox, label) each time, in which img is generated by Image.open(...).convert('RGB'); bbox is a 2d numpy array and label is 1d array. The 2nd class inherited from the first class and the major responsibiliyt of this class is to wrap the truths of an image in a BoxList object [__getitem__](https://github.com/facebookresearch/maskrcnn-benchmark/blob/f25c6cff92d32d92abe8965d68401004e90c8bee/maskrcnn_benchmark/data/datasets/coco.py#L43)
